...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for order in all_orders:
            order.datetime_created = faker.date_time_ad(start_datetime=datetime(2022,6,1), end_datetime=datetime(2024,6,1))
        print('DONE')
        ...
        for product in all_products:
            for _ in range(random.randint(1, 5)):
                ...
                comment.datetime_created = faker.date_time_ad(start_datetime=datetime(2015,1,1), end_datetime=datetime(2024,6,1))
        print('DONE')
